...
class PodcastArchive extends IcmsPersistableSeoObject {
		...
		if ($valid == true) {
			...
			if (!empty($soundtrackObj)) {
				...
				if ($soundtrack['source']) {
					...
					$criteria->add(new Criteria('source', $soundtrackObj->getVar('source', 'e')));
...
class PodcastArchiveHandler extends IcmsPersistableObjectHandler {
